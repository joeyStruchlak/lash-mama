          ...
          <div className="flex gap-2">
            <div
              className={`flex-1 h-1 rounded-full ${
                booking.step >= 1 ? 'bg-gold-600' : 'bg-gold-100'
              }`}
            />
            <div
              className={`flex-1 h-1 rounded-full ${
                booking.step >= 2 ? 'bg-gold-600' : 'bg-gold-100'
              }`}
            />
            <div
              className={`flex-1 h-1 rounded-full ${
                booking.step >= 3 ? 'bg-gold-600' : 'bg-gold-100'
              }`}
            />
            <div
              className={`flex-1 h-1 rounded-full ${
                booking.step >= 4 ? 'bg-gold-600' : 'bg-gold-100'
              }`}
            />
          </div>
        </div>
